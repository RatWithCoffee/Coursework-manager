...
public class RecordRepo {
    ...
    // Метод для добавления записи в coursework_record и возврата ID
    public static int add(int cwId, int teacherId, int groupId) {
    ...
    public static void edit(int recordId, int cwId, int teacherId, int groupId) {
    ...
    public static List<CourseworkRecord> getAll() {
    ...
    // here is the problem
    public static List<CourseworkRecord> getAllByGroup(int groupId) {
        List<CourseworkRecord> records = new ArrayList<>();
        String query = "SELECT cr.id, cr.cw_id, c.id AS coursework_id, c.name AS coursework_name, " +
                "t.id AS teacher_id, t.name AS teacher_name, t.job_title AS job_title, " +
                "g.id AS group_id, g.name AS group_name " +
    ...
    public static void remove(int cwId) {
